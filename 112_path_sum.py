...
def hasPathSum(root,s):
	...
	if root == None:
		...
		return False
	if root.left == None and root.right == None and (s - root.val) == 0:
			return True
...
t4.left = Node(4)
t4.right= Node(8)
t4.left.left = Node(11)
t4.left.left.left = Node(7)
t4.left.left.right = Node(2)
t4.right.left = Node(13)
t4.right.right = Node(4)
t4.right.right.right = Node(1)

#display(t4)
out = hasPathSum(t4,22)
print "Sum....."
print out